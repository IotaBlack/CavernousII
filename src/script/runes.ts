class Rune<runeName extends anyRuneName = anyRuneName> {
    ...
    icon: mapChar;
    isInscribable: {
        (this: Rune, spend?: boolean): boolean;
        itemCount?: number;
    };
    manaCost: number;
    description: () => string;
    ...
    new Rune(
        ...
        () => {
            return (
                ...
                " as much time to charge as the plants you're trying to kill would take to chop.<br>Requires:<br>{'0':'1 Salt<br>1 Iron Ore<br>1 Gold Nugget','1':'2 Salt<br>2 Iron Ore<br>2 Gold Nuggets'}"
            );
        },
        null,
        "Charge Wither"
    ...
    new Rune(
        ...
        () => {
            return (
                ...
                " of each (orthogonally or diagonally) adjacent resource (when mined), though each rune placed in a zone makes it harder to charge others."
            );
        },
        createDuplication,
        "Charge Duplication"
