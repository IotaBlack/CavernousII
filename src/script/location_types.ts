class LocationType<locationTypeName extends string = string> {
    ...
    getEnterAction(entered: number): anyAction | null {
...
const locationTypes = [
    ...
    new LocationType(
        "Strange Machine",
        "♥",
        "A strange machine labelled '{'0':'Clone Machine','1':'Rune Enhancer','2':'Rune Enhancer'}'.  What could it do?",
        "Walk",
        "Activate Machine",
        null,
        getNextActivateCost
    ...
    new LocationType(
        "Runic Book",
        '"',
        `A large book sitting open on a pedestal.  It has 4 pages, each with a different rune more complicated than the last.  Runic Lore has a greater effect on this action than normal.`,
        "Walk",
        "Read",
        null
    ),
    ...
    new LocationType(
        "Sporeshroom",
        "α",
        "A giant mushroom which grows quickly.  While you cut it, it lets out poisonous spores, injuring your clones. (Growth: 1+{'0':0.1,'2':0.5}t)",
        "Spore Chop",
        null,
        null
    ),
